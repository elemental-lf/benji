...
K8S_VERSION_SPEC_VOLUME_INFO = 'volumeInfo'
K8S_VERSION_SPEC_VOLUME_INFO_PERSISTENT_VOLUME_NAME = 'persistentVolumeName'
K8S_VERSION_SPEC_VOLUME_INFO_PERSISTENT_VOLUME_CLAIM_NAME = 'persistentVolumeClaimName'
K8S_VERSION_SPEC_VOLUME_INFO_STORAGE_CLASS_NAME = 'storageClassName'

K8S_VERSION_SPEC_VOLUME_INFO_RBD_CLUSTER_FSID = 'clusterFSID'
K8S_VERSION_SPEC_VOLUME_INFO_RBD_IMAGE_SPEC = 'imageSpec'
