...
backup_start_time = Gauge('benji_backup_start_time', labelnames=['version_name'], documentation='Start time of Benji backup command (time_t)', registry=backup_registry)
backup_completion_time = Gauge('benji_backup_completion_time', labelnames=['version_name'], documentation='Completion time of Benji backup command (time_t)', registry=backup_registry)
backup_runtime_seconds = Gauge('benji_backup_runtime_seconds', labelnames=['version_name'], documentation='Runtime of Benji backup command (seconds)', registry=backup_registry)
backup_status_succeeded = Gauge('benji_backup_status_succeeded', labelnames=['version_name'], documentation='Benji backup command succeeded', registry=backup_registry)
backup_status_failed = Gauge('benji_backup_status_failed', labelnames=['version_name'], documentation='Benji backup command failed', registry=backup_registry)
