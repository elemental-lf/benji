...
then
    benji::batch_deep_scrub "$DEEP_SCRUBBING_VERSIONS_PERCENTAGE" "$DEEP_SCRUBBING_BLOCKS_PERCENTAGE"
fi

if [[ $SCRUBBING_ENABLED == 1 ]]
then
    benji::batch_scrub "$DEEP_SCRUBBING_VERSIONS_PERCENTAGE" "$DEEP_SCRUBBING_BLOCKS_PERCENTAGE"
fi
